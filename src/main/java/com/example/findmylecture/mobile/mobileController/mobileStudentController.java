...
public class mobileStudentController {
    ...
    public ResponseEntity<?> viewSchedulesForStudent(@RequestBody String username) {

        List<TimeTableDto> timeTableDtoList = timeTableService.studentsSchedulesForThisWeek(username);
        List<MobileBatchDto> mobileBatchDtoList = new ArrayList<>();
