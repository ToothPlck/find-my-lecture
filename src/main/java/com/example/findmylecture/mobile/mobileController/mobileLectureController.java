...
@RestController
@RequestMapping("/mobile/lecturer")
public class mobileLectureController {
    ...
    public ResponseEntity<?> viewSchedulesForToday(Authentication authentication) {
        ...
        List<TimeTableDto> timeTableDtoList = timeTableService.lecturersSchedulesForThisWeek(authentication.getName());
