...
<html>
<head>
    <title>Student Handler - Register</title>
    ...
    <div style="margin-top: 80px;">
        <form:form id="formSubmit" modelAttribute="userForm" method="post">
            <div class="col-lg-4 col-md-4 col-sm-4 container justify-content-center">
                ...
                <div class="mb-3">
                    <label style="color: #414141;" class="form-label">Batch</label>
        ...
        <footer class="text-center text-lg-start" style="padding: 10px 0">
            <div class="text-center p-3" style="color: #998d88">
                ...
                <a style="color: #998d88;" class="text-center p-3"
                   href="${pageContext.request.contextPath}/handler/register">Find
                    My Lecture</a>
            </div>
        </footer>
    </nav>
...
<script>
    window.onload = function () {
        ...
        if (errorMessage !== "") {
            Swal.fire({
                title: "Error occurred while registering the student!!!",
                text: errorMessage,
                icon: "error",
            });
        }
    ...
    form.addEventListener('submit', function (event) {
        ...
        if (firstname.length < 2 || firstname.length > 15 || firstname.indexOf(' ') >= 0 || firstname.match(nameFormat)) {
            ...
            Swal.fire({
                title: 'Registering...',
                html: 'Hold on a few seconds while we register the student!',
                timer: 10000,
