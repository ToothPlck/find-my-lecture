...
<html>
<head>
    <title>Admin - Update ${room.roomName}</title>
                    ...
                    <div class="navbar-nav">
                        ...
                        <a class="nav-link" style="color: #FFFAF0"
                           href="${pageContext.request.contextPath}/admin/view/rooms">Class
                            rooms :
                            <a class="nav-link" style="color: #FFFAF0"
                               href="${pageContext.request.contextPath}/admin/update/room/${room.roomId}">${room.roomName}</a>
                        </a>
                    </div>
                    <div class="navbar-nav">
                        <a class="nav-link" style="color: #ffdf9e"
...
<div class="container">
    <div style="margin-top: 200px;">
        <form:form id="formSubmit" modelAttribute="room" method="post">
            <div class="col-lg-6 col-md-6 col-sm-6 container justify-content-center">
                <h1 style="color: #414141;">Update Class room : ${room.roomName}</h1>
                <div class="mb-3">
                    <label style="color: #414141;" class="form-label">Update Room name</label>
                    <form:input path="roomName" id="roomName" type="text" class="form-control" autofocus="autofocus"/>
                </div>
                <div class="mb-3">
                    <label style="color: #414141;" class="form-label">Update Room Type</label>
                    <form:input path="roomType" id="roomType" type="text" class="form-control"/>
                </div>
                <div class="mb-3">
                    <label style="color: #414141;" class="form-label">Update Room Description</label>
        ...
        <footer class="text-center text-lg-start" style="padding: 10px 0">
            <div class="text-center p-3" style="color: #998d88">
                ...
                <a style="color: #998d88;" class="text-center p-3"
                   href="${pageContext.request.contextPath}/admin/update/room/${room.roomId}">Find
                    My Lecture</a>
            </div>
        </footer>
    </nav>
...
<script>
    window.onload = function () {
        ...
        if (errorMessage !== "") {
            Swal.fire({
                title: "Error occurred while updating the classroom!!!",
                text: errorMessage,
                icon: "error",
            });
        }
    ...
    form.addEventListener('submit', function (event) {
        ...
        if (roomName.length < 3 || roomName.length > 25 || roomName.match(roomNameFormat)) {
            ...
            Swal.fire({
                title: 'Updating...',
                html: 'Hold on a few seconds while we update the classroom!',
                timer: 10000,
