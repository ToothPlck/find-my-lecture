                ...
                <table class="table" style="width: 100%; margin-top: 25px;">
                    ...
                    <c:forEach items="${batches}" var="batch">
                        <tr>
                            ...
                            <td>${batch.batchPeriod} months</td>
                            <td>${batch.intakeDate}</td>
                            <td>
                            ...
                            <td><a type="button" class="btn btn-outline-info"
                                   href="${pageContext.request.contextPath}/admin/update/batch/${batch.batchId}">Update</a>
                            </td>
                            <td><a type="button" class="btn btn-outline-danger"
                                   onclick="confirmDelete('${batch.batchId}')">Delete</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
        ...
        <footer class="text-center text-lg-start" style="padding: 10px 0">
            <div class="text-center p-3" style="color: #998d88">
                ...
                <a style="color: #998d88;" class="text-center p-3"
                   href="${pageContext.request.contextPath}/admin/view/batches">Find
                    My Lecture</a>
            </div>
        </footer>
    </nav>
...
<script>
    ...
    function confirmDelete(name) {
        Swal.fire({
            icon: 'question',
            title: 'Sure you want to delete this batch?',
            ...
            if (result.isConfirmed) {
                window.location.href = '/admin/delete/batch/' + name;
                Swal.fire({
                    title: 'Deleting...',
                    html: 'Hold on a few seconds while we delete the batch!',
                    timer: 10000,
