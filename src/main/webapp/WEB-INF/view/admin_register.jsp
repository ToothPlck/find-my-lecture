            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                        ...
                        <a class="nav-link active" style="color: #FFFAF0"
    ...
    <div style="margin-top: 80px;">
        <form:form id="formSubmit" modelAttribute="userForm" method="post">
            <div class="col-lg-4 col-md-4 col-sm-4 container justify-content-center">
                ...
                <div class="mb-3">
                    <label style="color: #414141;" class="form-label">NIC</label>
                    <form:input path="nic" id="nic" type="text" maxlength="12" class="form-control"/>
                </div>
                <div class="mb-3">
                    <label style="color: #414141;" class="form-label">Contact Number</label>
                    <form:input path="contactNumber" id="phone" type="text" maxlength="10" class="form-control"/>
                </div>
                <div class="mb-3">
                    <label style="color: #414141;" class="form-label">Role</label>
                    <form:select path="role" class="form-control">
                        <c:forEach items="${userRoles}" var="roles">
                            <form:option value="${roles.roleId}"
                                         cssStyle="color: #414141">${roles.roleName}</form:option>
                        </c:forEach>
                    </form:select>
                </div>
                <div>
                ...
                <div class="col text-center">
                    <button type="submit" id="button" class="btn btn"
                            style="color: floralwhite; border-color: #414141; background-color: #414141; margin-bottom: 25px;">
                        Register
                    </button>
                </div>
            </div>
...
<script>
    ...
    form.addEventListener('submit', function (event) {
        ...
        if (firstname.length < 2 || firstname.length > 15 || firstname.indexOf(' ') >= 0 || firstname.match(nameFormat)) {
            ...
            Swal.fire({
                title: "Error in nic!!!",
                text: "->The NIC cannot be kept empty\n" +
                    "-> The NIC cannot contain white spaces!\n " +
                    "-> The NIC should be in the correct format!",
                icon: "error",
            });
