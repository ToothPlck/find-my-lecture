...
<html>
<head>
    <title>Lecturer - Update Account</title>
        ...
        <form:form method="post" modelAttribute="loggedUser">
            <div class="col-lg-6 col-md-6 col-sm-6 container justify-content-center">
                ...
                <div class="mb-3">
                    ...
                    <form:input path="firstname" id="firstname" maxlength="15" type="text" class="form-control"
                                autofocus="autofocus"/>
                </div>
                <div class="mb-3">
                ...
                <div class="col text-center">
                    <a href="${pageContext.request.contextPath}/lecturer/view/account"
        ...
        <footer class="text-center text-lg-start" style="padding: 10px 0">
            <div class="text-center p-3" style="color: #998d88">
                ...
                <a style="color: #998d88;" class="text-center p-3"
                   href="${pageContext.request.contextPath}/lecturer/update/account">Find
                    My Lecture</a>
            </div>
        </footer>
    </nav>
