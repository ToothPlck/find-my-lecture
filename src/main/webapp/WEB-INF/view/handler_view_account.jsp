...
<html>
<head>
    <title>Handler - View Account</title>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 container justify-content-center">
                ...
                <div class="col text-center">
                    <a class="btn btn" style="color: floralwhite; border-color: #414141; background-color: #414141"
                       href="${pageContext.request.contextPath}/handler/update/account">Update
                        Account</a>
                </div>
            </div>
        </form:form>
        ...
        <footer class="text-center text-lg-start" style="padding: 10px 0">
            <div class="text-center p-3" style="color: #998d88">
                ...
                <a style="color: #998d88;" class="text-center p-3"
                   href="${pageContext.request.contextPath}/handler/view/account">Find
                    My Lecture</a>
            </div>
        </footer>
    </nav>
