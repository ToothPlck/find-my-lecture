...
<html>
<head>
    <title>Admin - View Lecturers</title>
                ...
                <table class="table" style="width: 100%; margin-top: 25px;">
                    ...
                    <c:forEach items="${lecturers}" var="lecturers">
                        <tr>
                            ...
                            <td>
                                <c:forEach items="${lecturers.modules}" var="modules">
                                    ${modules.moduleName} <br>
                                </c:forEach>
                            </td>
                            <td>
                                <a type="button" class="btn btn-outline-info"
                                   href="${pageContext.request.contextPath}/admin/update/lecturer/${lecturers.username}">Update</a>
                            </td>
                            <td>
                                <a type="button" class="btn btn-outline-danger"
                                   onclick="confirmDelete('${lecturers.username}')">Delete</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
        ...
        <footer class="text-center text-lg-start" style="padding: 10px 0">
            <div class="text-center p-3" style="color: #998d88">
                ...
                <a style="color: #998d88;" class="text-center p-3"
                   href="${pageContext.request.contextPath}/admin/view/lecturers">Find
                    My Lecture</a>
            </div>
        </footer>
    </nav>
...
<script>
    ...
    function confirmDelete(name) {
        Swal.fire({
            icon: 'question',
            title: 'Sure you want to delete this lecturer?',
            ...
            if (result.isConfirmed) {
                window.location.href = '/admin/delete/lecturer/' + name;
                Swal.fire({
                    title: 'Deleting...',
                    html: 'Hold on a few seconds while we delete the user!',
                    timer: 10000,
