        ...
        <form:form id="formSubmit" modelAttribute="moduleForm" method="post">
            <div class="col-lg-4 col-md-4 col-sm-4 container justify-content-center">
                ...
                <div class="mb-3">
                    ...
                    <form:select id="lecturer" path="user" class="form-control">
                        <form:option value="">Select Lecturer</form:option>
                        <c:forEach items="${lecturer}" var="lecturer">
                            <form:option value="${lecturer.username}"
                                         cssStyle="color: #414141">${lecturer.firstname} ${lecturer.lastname} (${lecturer.username})</form:option>
                        </c:forEach>
                    </form:select>
                </div>
        ...
        <footer class="text-center text-lg-start" style="padding: 10px 0">
            <div class="text-center p-3" style="color: #998d88">
                ...
                <a style="color: #998d88;" class="text-center p-3"
                   href="${pageContext.request.contextPath}/admin/add/module">Find
                    My Lecture</a>
            </div>
        </footer>
    </nav>
...
<script>
    ...
    form.addEventListener('submit', function (event) {
        ...
        if (moduleName.length < 3 || moduleName.length > 50 || moduleName.match(moduleNameFormat)) {
            ...
            // else if (lecturer.length < 1) {
            //     event.preventDefault();
            //     Swal.fire({
            //         title: "Error in module lecturer!!!",
            //         text: "-> Please enter a lecturer for the created module!",
            //         icon: "error",
            //     });
        // }
        else {
            Swal.fire({
                title: 'Adding...',
                html: 'Hold on a few seconds while we add the module!',
                timer: 10000,
